...
colnames(gr) <- c("Leto", "Stopnja razvoja")
...
colnames(usinf) <- c("Leto", "Stopnja brezposelnosti")
usinf <- usinf %>% filter(Leto <= 2014 & Leto >= 1950)
usinf <- usinf %>% arrange(desc(Leto))
