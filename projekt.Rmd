...
## Ugotovitve
V prvih desetletjih po 2. svetovni vojni vidimo, da je BDP Amerike rastel precej konstantno. Za rast so imeli tudi odlične pogoje, saj vojno razdejanje Amerike ni doseglo v velikem obsegu. Ta leta so bila za Ameriko zelo pomembna, saj se je uveljavila kot svetovna velesila. V letih 1978-1982 se je BDP skoraj ustavil na približno 6.5 trilijonov $. Po letu 1982 pa BDP raste eksponentno, medtem, ko rast BDP-ja postopoma pada, kot se vidi tudi v tretjem grafu. To je bilo obdobje, ko je veliko držav tudi opustilo komunizem in so posledično začele ujemati ZDA v BDP. V letu 2008 je BDP opustošila recesija, ko je BDP padel za približno pol trilijona $. V naslednjih nekaj letih pa si je ekonomija nekoliko opomogla in BDP zopet začne postopoma rasti.

   Če si ogledamo graf kot celoto, vidimo da BDP raste eksponentno v času do leta 2000. Po letu 2000 je BDP raste občutno počasneje, vendar vseeno konstantna. 
...
## Ugotovitve
Graf stopnje rasti me je nekoliko presenetil, saj je skozi celotno obravnavano obdobje zelo volatilen. Vidimo, da je rast v prvih letih po vojni ogromna. Če pa pogledamo povprečje grafa pa vidimo, da rast počasi pada, kar je tudi smiselno, saj so ZDA med najbolj razvitimi državami in je hitra rast na takem nivoju razvitosti zmeraj težja. 
...
## Ugotovitve
Iz grafa inflacije sem si pojasnil marsikateri pojav iz prejšnjih grafov. Kot sem že omenil, je bila inflacije v začetku petdesetih let izjemno visoka, leta 1951 je dosegla kar 7.9%. Do sedemdesetih let je inflacija v povprečju rastla. V letih 1974 ter 1979-1981 pa je bila neobičajno visoka, ko se je gibala kar okoli 11%. Obdobju na prelomu desetletja je bilo označeno kot obdobje podivjane inflacije. S tem pojavom bi lahko pojasnil prelom grafov BDP, BDP p.c. ter indeksa cen, saj se vsi rahlo prelomijo v tem obdobju. Po letu 1981 pa v povprečju stopnja inflacije pada. 

Omeniti velja tudi leti 1955 in 2009, ko inflacija celo pade pod 0%. V obeh primerih je omenjene deflacije 0.4%. Deflacija leta 1955 je bila še v obdobju, ko le-ta ni bila neobičajen pojav. Naslednje leta 2009 pa je ravno v času krize. Nekatere države, npr. Kolorado so ta pojav poskusile rešiti z znižanjem minimalne plače, ki je povezana z stopnjo inflacije.
...
Daleč največji delež ameriškega BDP-ja je BDP Kalifornije - kar dobrih 15%. Naslednja zvezna država po velikosti BDP je Teksas - nekaj malega pod 10% BDP-ja. Tretja po velikosti pa je zvezna država New York - skoraj točno 9% BDP-ja. Torej vidimo, da je skupni delež treh najbogatejših zveznih držav kar dobrih 34% celotnega BDP. 
...
## Ugotovitve
   ...
   Aljaska spada med 5. najrevnejšo zvezno državo s približno 50.9 milijard $, torej le slabe 3 milijarde $ več od slovenskega BDP-ja, Havaji pa so 13. najrevnejša zvezna država z 82.5 milijard $. 
